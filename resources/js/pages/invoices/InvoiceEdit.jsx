...
export default function InvoiceEdit() {
    ...
    const loadData = async () => {
        try {
            const [invoiceRes, clientsRes, productsRes] = await Promise.all([
                invoicesApi.get(id),
                        ...
                        <div className="mt-6 border-t pt-4">
                            ...
                            {parseFloat(form.tax_percent) > 0 && (
                                <div className="flex justify-between py-2">
                                    ...
                                    <span className="font-medium">{formatCurrency(calculateSubtotal() * parseFloat(form.tax_percent) / 100)}</span>
                                </div>
                            )}
                            {parseFloat(form.discount) > 0 && (
                                <div className="flex justify-between py-2">
                                    <span className="text-gray-600">Discount:</span>
                                    <span className="font-medium text-red-600">-{formatCurrency(parseFloat(form.discount))}</span>
                                </div>
                            )}
